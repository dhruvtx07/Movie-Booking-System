...
// Set adminUserId to the logged-in user's ID for "My Events" dashboard
...
// Fetch all events by active status, then filter by event creator if $adminUserId is relevant
...
<head>
 ...
 <title>My Events Dashboard - Catchify</title> <!-- Changed Title -->
...
<div class="content-wrapper" id="contentWrapper">
 ...
 <main class="main-content" id="mainContent">
  <div class="container py-4">
   <h2 class="section-title">My Events Analytics</h2> <!-- Changed Title -->
   ...
   <div class="card p-4 mb-4 d-none" id="filterCard" style="background-color: var(--secondary-bg); border: 1px solid var(--card-border);">
    <h4 class="mb-3 text-white">Apply Filters for My Events</h4> <!-- Changed Subtitle -->
    <form action="" method="GET" id="filterForm">
     <div class="row g-3">
      ...
      <div class="col-12 text-end">
       ...
       <a href="events_dashboard.php" class="btn btn-secondary ms-2"><i class="fas fa-sync-alt me-2"></i>Reset Filters</a>
      </div>
     </div>
    </form>
   </div>

   <h3 class="section-subtitle">Overall Performance (My Events)</h3> <!-- Changed Subtitle -->
   <div class="row mb-4">
     ...
     <div class="row">
      <div class="col-lg-8 mb-3"> <!-- Tickets Sold (wide) -->
       <div class="metric-card">
        ...
        <p class="text-muted">Total number of tickets booked for your events between<br><?= (new DateTime($start_datetime))->format('M d, Y') ?> - <?= (new DateTime($end_datetime))->format('M d, Y') ?></p>
       </div>
      </div>
     ...
     <div class="row">
      <div class="col-md-4 mb-3">
       <div class="metric-card blue">
        ...
        <p class="text-muted">Sum of original ticket prices for your events before any discounts.</p>
       </div>
      </div>
      <div class="col-md-4 mb-3">
       <div class="metric-card red">
        ...
        <p class="text-muted">Total value of promo codes and other discounts applied to your events.</p>
       </div>
      </div>
      <div class="col-md-4 mb-3">
       <div class="metric-card green">
        ...
        <p class="text-muted">Total amount paid by customers for your events after all discounts.</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <h3 class="section-subtitle">Revenue Breakdown (My Events)</h3> <!-- Changed Subtitle -->
   <div class="row mb-4">
    <div class="col-md-12 mb-3"> <!-- First sub-row for Net Revenue (Customer Paid) -->
     <div class="metric-card green">
      <h5>Total Net Revenue for My Events</h5>
      <div class="display-4"><i class="fas fa-indian-rupee-sign"></i> <?= number_format($net_revenue_after_promo, 2) ?></div>
      <p class="text-muted">Total amount paid by customers for your events after all discounts.</p>
     </div>
    </div>
    <div class="col-md-12 mb-3"> <!-- Second sub-row for commissions and creator revenue -->
     <div class="row">
      <div class="col-md-4 mb-3">
       <div class="metric-card purple">
        ...
        <p class="text-muted">Charges applied by the platform on your events.</p>
       </div>
      </div>
      <div class="col-md-4 mb-3">
       <div class="metric-card cyan">
        ...
        <p class="text-muted">Any other Host specific charges applied to your events (e.g. host fee).</p>
       </div>
      </div>
      <div class="col-md-4 mb-3">
       <div class="metric-card gold"> <!-- New card with 'gold' styling -->
        <h5>Your Revenue from Events</h5>
        <div class="display-4"><i class="fas fa-indian-rupee-sign"></i> <?= number_format($creator_revenue_amount, 2) ?></div>
        <p class="text-muted">The portion of net revenue allocated directly to you as event creator.</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <h3 class="section-subtitle">Promo Code Performance (My Events)</h3> <!-- Changed Subtitle -->
   <?php if (empty($promo_code_stats)): ?>
    <div class="alert alert-info">No promo codes used within the selected filters for your events.</div>
   <?php else: ?>
   ...
   <!-- Removed Ticket-wise breakdown table, as it's now embedded in Overall Performance -->

   <h3 class="section-subtitle">Top Events, Cities, & Venues (My Events)</h3> <!-- Changed Subtitle -->
   <div class="row">
    <div class="col-md-4 mb-4">
     <div class="metric-card">
      <h5>Top 5 of My Events by Revenue</h5> <!-- Changed Title -->
      <ul class="list-group list-group-flush">
       <?php if (empty($top_events)): ?>
        <li class="list-group-item">No events from your account found.</li> <!-- Changed text -->
       <?php else: ?>
    ...
    <div class="col-md-4 mb-4">
     <div class="metric-card">
      <h5>Top 5 Cities for My Events by Revenue</h5> <!-- Changed Title -->
      <ul class="list-group list-group-flush">
       <?php if (empty($top_cities)): ?>
        <li class="list-group-item">No cities related to your events found.</li> <!-- Changed text -->
       <?php else: ?>
    ...
    <div class="col-md-4 mb-4">
     <div class="metric-card">
      <h5>Top 5 Venues for My Events by Revenue</h5> <!-- Changed Title -->
      <ul class="list-group list-group-flush">
       <?php if (empty($top_venues)): ?>
        <li class="list-group-item">No venues related to your events found.</li> <!-- Changed text -->
       <?php else: ?>
 ...
 navLinks.forEach(link => {
  ...
  if (linkFilename === currentFilename) {
   ...
   if (currentFilename === 'dashboard.php') {
    // No specific action needed here if it's already handled by the above logic.
    // This specific check might be redundant if the current filename logic is robust.
   }
  }
 });
