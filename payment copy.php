                                ...
                                <div class="promo-codes-dropdown">
                                    ...
                                    <div class="promo-codes-content" id="promoCodesContent">
                                        ...
                                        foreach ($availablePromoCodes as $promo):
                                            // Only display if not already maxed out and is active
                                            if ($promo['times_used'] < $promo['max_redemptions'] && $promo['is_active'] == 'yes'):
                            ...
                            <div class="tab-pane fade show active" id="credit-card" role="tabpanel">
                                <form method="post" id="cardPaymentForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cardNumber" placeholder="1234 5678 9012 3456" required pattern="(\d{4}\s?){3}\d{4}" title="Please enter a 16-digit card number" maxlength="19">
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
        ...
        if (searchInput) {
            searchInput.addEventListener('input', function() {
                ...
                if (searchTerm.length >= 2) {
                    ...
                    fetch(`${searchPage}?search=${encodeURIComponent(searchTerm)}`)
                        ...
                        .then(data => {
                            if (data.length > 0) {
                                ...
                                data.forEach(item => {
                                    html += `
                                        <a href="${eventInfoPage}?id=${item.event_id}" class="search-result-item">
