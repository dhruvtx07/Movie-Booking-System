...
function sendOTPEmail($email, $otp) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;                                  
        $mail->Username   = 'tdhruv425@gmail.com';        // Your Gmail address
        $mail->Password   = 'sdfd ymcz wpoh vslw';          // Use App Password here
        ...
        if (empty($newPassword) || empty($confirmPassword)) {
            ...
            if ($stmt = $conn->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    $_SESSION['reset_step'] = 4; // Success step
...
if (isset($_GET['resend_otp']) && $step === 2 && isset($_SESSION['reset_email'])) {
    ...
    // Redirect to prevent duplicate requests
    header("Location: forgot_pass.php");
    exit();
}
?>
...
<head>
    ...
    <title>Password Reset | CatchIfy </title>
        ...
        <div class="password-container">
            ...
            <?php if (!empty($success)): ?>
                <div class="alert alert-success mb-4 text-center">
                    ...
                    <a href="login.php" class="btn btn-bms">Back to Login</a>
                </div>
            <?php endif; ?>
            ...
            <?php elseif ($step === 2): ?>
                ...
                <form method="POST" action="forgot_pass.php" id="otpForm">
                    <div class="mb-4 text-center">
                        <p>We've sent a 6-digit OTP to your email <strong><?php echo $_SESSION['reset_email']; ?></strong></p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control otp-input" id="otp" name="otp" placeholder="123456" maxlength="6" required>
                        </div>
            ...
            <?php elseif ($step === 4): ?>
                ...
                <div class="success-container">
                    ...
                    <p class="success-message">Your password has been updated successfully. You can now login with your new password.</p>
                    <a href="login.php" class="btn btn-bms btn-lg">
            ...
            if (resendOtpBtn) {
                ...
                function updateCountdown() {
                    if (countdown > 0) {
                        ...
                        countdownEl.innerHTML = `(<span class="countdown">${countdown}</span>s)`;
                        countdown--;
                ...
                if (form) {
                    form.addEventListener('submit', function() {
                        ...
                        if (loader) {
                            ...
                            if (formId === 'emailForm') {
                                loaderText.textContent = 'Sending OTP...';
